...
func (uf userFacade) CreateUserByEmail(
	...
	err = facade.RunReadwriteTransaction(ctx, func(ctx context.Context, tx dal.ReadwriteTransaction) (err error) {
		...
		//if err = userEmail.Data.SetPassword(dal4debtus.RandomCode(8)); err != nil {
		//	return
		//}
		//
...
func (uf userFacade) GetOrCreateEmailUser(
	...
	err = facade.RunReadwriteTransaction(ctx, func(ctx context.Context, tx dal.ReadwriteTransaction) (err error) {
		...
		//err = nil // Clear dal4debtus.ErrRecordNotFound
		...
		//var to db.RunOptions = dal4debtus.CrossGroupTransaction
...
//		userGoogle, err = dal4debtus.UserGoogle.GetUserGoogleByID(ctx, googleUser.ContactID)
...
//		if userEmail, err = dal4debtus.UserEmailEntry.GetUserEmailByID(c, tx, email); err != nil && !dal.IsNotFound(err) {
//			return // error
//		}
//
...
//
//			if isNewUser {
//				if appUser, err = dal4debtus.UserEntry.CreateUser(c, appUser.Data); err != nil {
//					return
//				}
...
//				if err = dal4debtus.UserEmailEntry.SaveUserEmail(c, tx, userEmail); err != nil {
//					return
//				}
//			}
...
//		if userFacebook, err = dal4debtus.UserFacebook.GetFbUserByFbID(ctx, fbAppOrPageID, fbUserOrPageScopeID); err != nil {
