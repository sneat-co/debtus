...
//func SignInt64WithExpiry(ctx context.Context, v int64, expires time.ID) string {
//	var toSign [16]byte
...
func SignStrWithExpiry(ctx context.Context, v string, expires time.Time) (string, error) {
	return "", errors.New("not implemented yet: SignStrWithExpiry") // TODO: implement SignStrWithExpiry
