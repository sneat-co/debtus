...
type BillCommon struct {
	...
	SpaceID coretypes.SpaceID `firestore:"spaceID"`
...
func (entity *BillCommon) AssignToGroup(groupID string) (err error) {
	...
	if entity.SpaceID == "" {
		entity.SpaceID = coretypes.SpaceID(groupID)
	} else if entity.SpaceID != coretypes.SpaceID(groupID) {
