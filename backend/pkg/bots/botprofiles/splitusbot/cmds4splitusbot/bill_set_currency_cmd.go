...
import (
	...
	"github.com/sneat-co/debtus/backend/pkg/modules/splitus/dal4splitus"
...
const setBillCurrencyCommandCode = "set_bill_currency"

var setBillCurrencyCommand = billCallbackCommand(setBillCurrencyCommandCode,
	func(whc botsfw.WebhookContext, tx dal.ReadwriteTransaction, callbackUrl *url.URL, bill models4splitus.BillEntry) (m botmsg.MessageFromBot, err error) {
		ctx := whc.Context()
