...
//	case "debtus.app":
//		return fbProd.App(), "debtus.app", nil
//	case "dev.debtus.app":
...
//		fbSession.HttpClient = dal4debtus.Default.HttpClient(ctx)
//		return
//	})
//}
//
...
//		//fbSession, err = fbApp.SessionFromSignedRequest(c, signedRequest, dal4debtus.Default.HttpClient(c))
//		//if err != nil {
