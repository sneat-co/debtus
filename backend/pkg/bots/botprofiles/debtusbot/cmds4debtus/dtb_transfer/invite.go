...
//	err = dal4debtus.DB.RunInTransaction(c, func(tctx context.Context) (err error) {
...
//						UserTitle: counterparty.GetFullName(),
//					}); err != nil {
...
//			}
//		}
//		if err = delayed4debtus.DelayUpdateSpaceHasDueTransfers(tc, transfer.DebtusSpaceContactEntry().UserID); err != nil {
//			return err
//		}
