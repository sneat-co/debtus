...
func TestBalanceMessageSingleCounterparty(t *testing.T) {
	...
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 10 USD", expectedEn), actual)
	...
	actual = mockEn.ByContact(c, enLinker, contacts, debtusContacts)
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 20 EUR and 10 USD", expectedEn), actual)

	debtusContacts[johnID].Balance = money.Balance{"USD": 1000, "EUR": 2000, "RUB": 1500}
	actual = mockEn.ByContact(c, enLinker, contacts, debtusContacts)
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 20 EUR, 15 RUB and 10 USD", expectedEn), actual)
...
func TestBalanceMessageTwoCounterparties(t *testing.T) {
	...
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 15 USD\n%v - owes to you 10 USD", jackLink, johnLink),
	...
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 40 USD and 15 EUR\n%v - owes to you 20 EUR and 10 USD", jackLink, johnLink),
	...
	jackDebtusContactBrief.Balance = money.Balance{"USD": 4000, "EUR": 1500}
	assertText(t, i18n.LocaleEnUS, 0, fmt.Sprintf("%v - owes to you 100 RUB, 20 EUR and 10 USD\n%v - owes to you 40 USD and 15 EUR", johnLink, jackLink),
		enMock(t).ByContact(c, enLinker,
			contacBriefs,
			map[string]*models4debtus.DebtusContactBrief{
				johnID: &johnDebtusContactBrief,
