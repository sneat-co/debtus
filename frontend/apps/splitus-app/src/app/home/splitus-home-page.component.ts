...
// Authenticated landing page for splitus.app. Reuses the shared
  ...
  template: `
    <ion-header>
      <ion-toolbar>
        ...
        <ion-title>Splitus.app</ion-title>
      </ion-toolbar>
    </ion-header>
...
export class SplitusHomePageComponent {}
